...
public class FitnessCalculator{
  ...
  public static void main(String[] args) {
    ...
    int[] test = {2, 0, 10, 6, 9, 11, 5, 14, 3, 8, 13, 7, 12, 4, 1};
    shreddedDocument = getShreddedDocument("document1-shredded.txt"); //This reads a -shredded.txt file from disk 
    System.out.println("The fitness of document1-shredded.txt is " + fitness(shreddedDocument, test));
    System.out.println("Here is what the shredded document looks like");
    prettyPrint(shreddedDocument);

    System.out.println("---");

    char[][] myShreddedDocument = getShreddedDocument("document2-shredded.txt");
    int[] mySolution = { 7, 2, 6, 9, 1, 10, 14, 0, 12, 3, 4, 13, 8, 11, 5 };

    System.out.println("The fitness of document1-shredded.txt is " + fitness(myShreddedDocument, mySolution));
    System.out.println("Here is what the shredded document looks like");
    prettyPrint(myShreddedDocument);
